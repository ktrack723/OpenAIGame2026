...
export const ko = {
  ...
  'gnd.siegeLock': [
    '경보. 저놈이 겨눈 건 지구가 아니라 우리 공이다. 그 돌을 치워라.',
    '조준선 포착. 광선이 아니다. 저건 당구다.',
    '저놈이 우리 수를 배웠다. 저 공이 밀리면 다음은 우리 집이다.',
  ],
  'gnd.siegeNuke': [
    '조르그 핵 기폭. 저 공이 이쪽으로 온다.',
    '밀렸다. 이제 저 돌덩이가 어디로 가는지가 전부다.',
    '저쪽 탄두는 우리와 같은 규칙으로 움직인다. 그게 최악이다.',
  ],
  'gnd.laserHit': [
