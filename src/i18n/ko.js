...
export const ko = {
  ...
  'cat.gas': '가스 행성', 'cat.gas.mech': '터진다 — 대규모 유폭. 터져도 안 죽는다, 체력 1만 닳는다',
  ...
  'role.volatile': '가스 행성',
  'role.volatile.brief': '🪐 터진다. 핵을 맞거나 세게 처박히면 그 자리에서 유폭해 반경 안의 모든 천체를 밀어낸다. **터져도 사라지지 않는다** — 체력이 1 닳을 뿐이라 다 닳을 때까지 여러 번 쓸 수 있다.',
  'role.volatile.aim': '가스 행성 — 밀리면서 유폭한다 (주황 원 안이 전부 밀린다 · 체력 1 소모)',
