...
export const ko = {
  ...
  // ── 화면 위 표식 ──────────────────────────────────────────────
  'mark.target': '☠ 표적  {name}{home} · 체력 {hp}/{hpMax}{suffix}',
  'mark.home': ' ◈본성',
  'mark.left': ' (남은 요새 {n})',
  ...
  // ── 태그 ──────────────────────────────────────────────────────
  'role.battery': '조르그 요새',
  'role.battery.brief': '☠ 이게 표적이다. 보통은 체력 1, 대형(2판부터)은 2이고 그만큼 크다. 3판부터는 추진기를 하나씩 달고 와서 꽂히는 탄을 딱 한 번 옆으로 피한다 — 첫 발로 그걸 빼고 다음 발로 잡는다. 본성(◈)은 지구를 겨눠 광선을 충전하는 놈 — 먼저 부수면 충전이 취소되고 지휘권이 다음 요새로 넘어간다.',
  ...
  // ── 천체 정보창 ───────────────────────────────────────────────
  'insp.earth': '본대', 'insp.home': '본성', 'insp.plain': '태그 없음 · 일반 행성',
  ...
  'msg.laser.charge': '{name} 본성이 지구의 도달 지점을 겨눴다 — 지구를 밀면 조준점이 틀어진다',
  'msg.laser.abort': '조르그 레이저 — 충전 중 본성이 파괴되어 발사가 취소됐다',
  ...
  'toast.laser.charge': '조르그 레이저 조준 — {sec}초 뒤 발사. 조준점에서 비켜나라',
  'toast.laser.abort': '본성 파괴 — 레이저 조준 해제',
  ...
  'toast.home.next': '본성 격파 — {name}이(가) 지휘권을 승계',
  'toast.home.last': '조르그 본성 격파 — 레이저 침묵',
