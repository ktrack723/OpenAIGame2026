...
//
// 이 게임의 소리는 셋이 나눠 만든다: ZzFX(효과음) · Tone.js(음악) ·
// three(공간 오디오, 지금은 안 쓰지만 언젠가). **셋이 서로 다른
// AudioContext를 만들면** 브라우저마다 6~8개인 컨텍스트 상한을 금방
// 까먹고, 무엇보다 하나만 resume되고 나머지는 영영 잠들어 있는 사고가 난다.
// 그래서 컨텍스트는 우리가 하나 만들어서 셋에게 나눠 준다.
//
// ── 만드는 자리 ──
